...
#ifndef CONTENT_COMMON_MEDIA_MEDIA_PLAYER_INIT_CONFIG_H_
#define CONTENT_COMMON_MEDIA_MEDIA_PLAYER_INIT_CONFIG_H_
...
#endif  // CONTENT_COMMON_MEDIA_MEDIA_PLAYER_INIT_CONFIG_H_
